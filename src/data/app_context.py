...
class AppContext:
    ...
    def get_metadata(self) -> dict:
        ...
        """
        metadata = {
            'preset_file': str(self.preset_file),
            'manager_initialized': self._preset_manager is not None
        }
    ...
    def __repr__(self) -> str:
        ...
        return (f"AppContext(preset_file={self.preset_file.name}, "
                f"initialized={self._preset_manager is not None})")