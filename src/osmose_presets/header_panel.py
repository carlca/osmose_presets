   ...
   def on_mount(self) -> None:
      ...
      try:
         ...
         if saved_port and saved_port in self.ports:
            ...
            self.current_port_index = 0  # Default to first port

         # CRITICAL: Save the current valid port selection to config
         # This ensures the config always has a valid port name
